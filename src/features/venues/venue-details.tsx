  ...
  return (
    <div className="container">
      ...
      <div className="detail-photo">
        <VenueImage
          src={v.image}
          alt={`Illustrative event setting for ${v.name}; not a real listed property`}
          fill
          priority
          sizes="100vw"
        />
      ...
      <div className="detail-grid">
        ...
        <aside className="panel quote-card">
          ...
          <h2>
            {money(v.price)} <small>from</small>
          </h2>
          <p>
            Sample whole-venue guidance. The venue will confirm your exact
            inclusions, access and terms.
          </p>
